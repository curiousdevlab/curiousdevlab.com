...
$phpPath = env('PHP_PATH', '/opt/homebrew/bin/php');

$composerPath = env('COMPOSER_PATH', '/usr/local/bin/composer');
...
return [
    ...
    |
    */
    'enabled' => env('ENABLE_SERVER_MONITOR', false),
    ...
    */
    ...
    'route' => 'server-checker',
    'username' => 'curiousadmin',
    'password' => 'weare3Lucky!',
        ...
        'server' => [
            ...
            */
            ...
            \Sarfraznawaz2005\ServerMonitor\Checks\Server\HttpStatusCode::class => [
                'sites' => [
                    'homepage' => ['url' => env('APP_URL', ''), 'expected_code' => 200],
                ]
            ],
            ...
            'common' => [
               ...
               /*  \Sarfraznawaz2005\ServerMonitor\Checks\Application\DatabaseCanBeAccessed::class, */
                ...
                \Sarfraznawaz2005\ServerMonitor\Checks\Application\ComposerDependenciesUpToDate::class => [
                    ...
                    'binary_path' => "{$phpPath} {$composerPath}",
                ],
    ...
    'notifications' => [
        ...
        */
        ...
        'notification_notify_emails' => [
            'hello@curiousdevlab.com',
        ],

        // Define mail channel "from". Leave empty to use default.
        'notification_mail_from' => 'hello@curiousdevlab.com',
