...
const Note = ({ title, children }) => {
  return /* @__PURE__ */ jsxs("div", { className: "border-2 rounded-md w-full min-w-0 px-2 md:px-2 max-w-prose sm:max-w-none pb-[12px] border-yellow-500 my-12", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "px-4 py-6", children })
  ] });
};
const Post = ({ content, nextPost, prevPost }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("article", { className: "max-w-4xl m-auto px-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-center flex-wrap pb-2", children: [
          /* @__PURE__ */ jsx(
            "time",
            {
              ...
              children: new Date(frontMatter.date).toDateString("en-US")
            }
          ),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: frontMatter.tags.map((tag) => /* @__PURE__ */ jsxs("span", { className: "text-yellow-400 font-semibold", children: [
            "#",
            tag
          ] }, tag)) })
        ] }),
