...
const Home = ({ posts }) => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { children: /* @__PURE__ */ jsx("meta", { "head-key": "og:type", property: "og:type", content: "website" }) }),
    /* @__PURE__ */ jsxs("section", { className: "max-w-6xl m-auto px-4 pt-24 pb-24 text-center", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-xl", children: "Writing about Laravel and Javascript." })
    ] }),
    /* @__PURE__ */ jsxs("section", { className: "max-w-4xl m-auto px-4 pb-32", children: [
      ...
      /* @__PURE__ */ jsx("ul", { className: "flex flex-col space-y-6", children: posts.map((post, index) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("div", { className: "border border-gray-600 overflow-hidden hover:border-yellow-100 flex flex-col lg:flex-row lg:items-start justify-between py-4 px-4 bg-gray-900 rounded-md", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:pr-10", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold hover:underline", children: index <= 5 ? /* @__PURE__ */ jsx(CacheLink, { isStatic: true, href: post.slug, children: post.title }) : /* @__PURE__ */ jsxs(Link, { href: post.slug, children: [
            " ",
            post.title
          ] }) }),
