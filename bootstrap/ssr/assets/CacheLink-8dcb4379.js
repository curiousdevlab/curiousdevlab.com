...
const Footer = ({ children, ...props }) => {
  return /* @__PURE__ */ jsx("footer", { className: "max-w-4xl m-auto px-4 py-10", children: /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("p", { className: "text-gray-400 pb-3", children: [
      "Code highlighting provided by",
      " ",
      /* @__PURE__ */ jsx("a", { className: "hover:underline text-white", href: "https://torchlight.dev/", target: "_blank", children: "Torchlight" })
    ] }),
...
function Layout({ children }) {
  ...
  const handleCacheUpdated = () => {
    const pages = Op.cache().all();
    setCachedPages(Object.keys(pages).map((key) => {
      return { key, pending: pages[key].pending || false };
    }));
  };
  useEffect(() => {
    document.addEventListener("cache:updated", handleCacheUpdated);
    return () => {
      document.removeEventListener("cache:updated", handleCacheUpdated);
    };
  }, []);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { id: "top", className: "font-sans bg-[#0f141b] text-white text-sm font-normal leading-relaxed antialiased min-h-screen w-full", children: [
      /* @__PURE__ */ jsxs("main", { children: [
        !production ? /* @__PURE__ */ jsx("div", { className: "fixed top-5 right-5", children: /* @__PURE__ */ jsxs("div", { className: "bg-gray-900 border border-gray-700 px-3 py-2 rounded", children: [
        ...
        children,
        /* @__PURE__ */ jsx("div", { className: "fixed bottom-8 right-10", children: /* @__PURE__ */ jsxs("a", { href: "#top", className: "flex items-center hover:opacity-60 bg-gray-900 border border-gray-700 px-5 py-3 rounded-full", children: [
          /* @__PURE__ */ jsx(
            "svg",
            {
...
const CacheLink = ({ children, isStatic, ...props }) => {
  useEffect(() => {
    Op.cache().prefetch(props.href, { durationInMinutes: 5, isStatic: true });
  }, []);
  return /* @__PURE__ */ jsx(sl, { isStatic: true, ...props, children });
};
export {
  CacheLink as C,
  Layout as L
